...
#define OUT_DIGI_TRAN_5V		12
#define OUT_DIGI_TRAN_12V		13
...
/*   805   */
#define GPIO_DIGI_TRAN_5V_PORT	GPIOF
#define RCC_DIGI_TRAN_5V_PORT   RCC_AHB1Periph_GPIOF
#define GPIO_DIGI_TRAN_5V_PIN	GPIO_Pin_6

#define GPIO_DIGI_TRAN_12V_PORT	GPIOF
#define RCC_DIGI_TRAN_12V_PORT  RCC_AHB1Periph_GPIOF
#define GPIO_DIGI_TRAN_12V_PIN	GPIO_Pin_7
...
/*805*/
#define OUT_SW_DIGI_TRAN_5V_PIN()      GPIO_ReadOutputDataBit(GPIO_DIGI_TRAN_5V_PORT, GPIO_DIGI_TRAN_5V_PIN)
#define OUT_SW_DIGI_TRAN_12V_PIN()     GPIO_ReadOutputDataBit(GPIO_DIGI_TRAN_12V_PORT, GPIO_DIGI_TRAN_12V_PIN)
...
/*805*/
#define SW_DIGITAL_TRAN_5V_ENABLE   GPIO_SetBits(GPIO_DIGI_TRAN_5V_PORT,GPIO_DIGI_TRAN_5V_PIN)
#define SW_DIGITAL_TRAN_5V_DISABLE  GPIO_ResetBits(GPIO_DIGI_TRAN_5V_PORT,GPIO_DIGI_TRAN_5V_PIN)

#define SW_DIGITAL_TRAN_12V_ENABLE  GPIO_SetBits(GPIO_DIGI_TRAN_12V_PORT,GPIO_DIGI_TRAN_12V_PIN)
#define SW_DIGITAL_TRAN_12V_DISABLE GPIO_ResetBits(GPIO_DIGI_TRAN_12V_PORT,GPIO_DIGI_TRAN_12V_PIN)
